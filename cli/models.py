...
class TaskParameters(BaseModel):
    ...
    repo: Optional[str] = Field(
        default=None, description="Repository to run the task on"
    )
    ...
    file: Optional[str] = Field(
        default=None, description="File to use for the prompt template"
    )
    direct: bool = Field(default=False, description="Directly output the prompt")
    output: Optional[str] = Field(
        default=None, description="Output file for the prompt"
    )
    ...
    prompt: Optional[str] = Field(
        default=None, description="Prompt to use for the task"
    )
    branch: Optional[str] = Field(
        default=None, description="Branch to use for the task"
    )
